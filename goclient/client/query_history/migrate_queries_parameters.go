...
// NewMigrateQueriesParams creates a new MigrateQueriesParams object,
...
func NewMigrateQueriesParams() *MigrateQueriesParams {
	return &MigrateQueriesParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewMigrateQueriesParamsWithTimeout creates a new MigrateQueriesParams object
...
// NewMigrateQueriesParamsWithContext creates a new MigrateQueriesParams object
...
// NewMigrateQueriesParamsWithHTTPClient creates a new MigrateQueriesParams object
...
func (o *MigrateQueriesParams) WithContext(ctx context.Context) *MigrateQueriesParams {
	o.SetContext(ctx)
	return o
}
...
func (o *MigrateQueriesParams) WithBody(body *models.MigrateQueriesToQueryHistoryCommand) *MigrateQueriesParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the migrate queries params
func (o *MigrateQueriesParams) SetBody(body *models.MigrateQueriesToQueryHistoryCommand) {
	o.Body = body
}
