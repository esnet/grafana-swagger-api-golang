...
func (m *SearchResult) validateResult(formats strfmt.Registry) error {
...
func (m *SearchResult) contextValidateResult(ctx context.Context, formats strfmt.Registry) error {
