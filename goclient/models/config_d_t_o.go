...
func (m *ConfigDTO) validateDashboards(formats strfmt.Registry) error {
...
func (m *ConfigDTO) validateFormats(formats strfmt.Registry) error {
...
func (m *ConfigDTO) validateState(formats strfmt.Registry) error {
...
func (m *ConfigDTO) contextValidateDashboards(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigDTO) contextValidateFormats(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ConfigDTO) contextValidateState(ctx context.Context, formats strfmt.Registry) error {
